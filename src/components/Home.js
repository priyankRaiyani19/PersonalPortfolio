...
const Home = () => {
    return (
        <div name="Home" className="h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 border-b border-gray-500 overflow-x-hidden ">
            ...
            <div className="max-w-screen-lg mx-auto flex flex-col
             items-center justify-between h-full px-4 md:flex-row sm:flex-row">
                ...
                <div className='flex mt-[670px] h-[1000px] w-[2500px] hidden lg:flex'>
