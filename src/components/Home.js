             ...
             items-center justify-center h-full px-4 md:flex-row ">
                <div className="text-white flex flex-col justify-center h-full">
                    ...
                    <p className=" text-gray-400 font-bold py-4 max-w-screen-2xl ">
                        I specialize in frontend development, crafting responsive web applications with React.js and Tailwind CSS.
                ...
                <div>
                    <img src={HeroImg} alt="My photo" className="rounded-3xl mx-auto  h-[450px] w-[350px]  md:w-[825px]"/>
                </div>
            </div>
